...
let deku = async (m, {
    ...
    if (Object.keys(menu).find((a) => a === text.toLowerCase())) {
        ...
        let caption = Func.Styles(`Hai kKa ${m.pushName} , aku adalah bot otomatis ${readmore}. aku akan membantu mu tapi jangan spam ya kak, 
...
`);
        ...
        const xmenu_oh = `hai ${m.pushName} saya ${config.name} dan saya adalah bot wa di buat oleh hira
